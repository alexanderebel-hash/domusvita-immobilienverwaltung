...
INSERT INTO klienten (id, vorname, nachname, geburtsdatum, geschlecht, pflegegrad, besonderheiten, kontakt_name, kontakt_beziehung, kontakt_telefon, kontakt_email, status, anfrage_quelle, dringlichkeit, vermittler, bevorzugte_wgs, anfrage_am) VALUES
    ('k4000000-0000-0000-0000-000000000004', 'Test-AG', 'Testberg-33', '1942-05-20', 'weiblich', '3', 'Testnotiz Pflegebedarf A', 'Kontakt Testberg-33', 'Sohn', '+49 30 00000001', 'anonym33@example.de', 'neu', 'email', 'sofort', NULL, ARRAY['wg400000-0000-0000-0000-000000000004', 'wg500000-0000-0000-0000-000000000005']::UUID[], NOW() - INTERVAL '2 days'),
    ('k5000000-0000-0000-0000-000000000005', 'Test-AH', 'Testberg-34', '1937-09-12', 'männlich', '2', 'Testnotiz Pflegebedarf B', 'Kontakt Testberg-34', 'Tochter', '+49 30 00000002', 'anonym34@example.de', 'erstgespraech', 'telefon', '4_wochen', NULL, ARRAY['wg100000-0000-0000-0000-000000000001']::UUID[], NOW() - INTERVAL '5 days'),
    ('k6000000-0000-0000-0000-000000000006', 'Test-AI', 'Testberg-35', '1939-02-28', 'weiblich', '4', 'Testnotiz Pflegebedarf C', 'Kontakt Testberg-35', 'Tochter', '+49 30 00000003', 'anonym35@example.de', 'besichtigung_geplant', 'vermittlung', 'sofort', 'Vivantes Klinikum Neukölln', ARRAY['wg400000-0000-0000-0000-000000000004']::UUID[], NOW() - INTERVAL '3 days'),
    ('k7000000-0000-0000-0000-000000000007', 'Test-AJ', 'Testberg-36', '1944-08-05', 'weiblich', '3', 'Testnotiz Pflegebedarf D', 'Kontakt Testberg-36', 'Sohn', '+49 30 00000004', 'anonym36@example.de', 'unterlagen_gesendet', 'website', '3_monate', NULL, ARRAY['wg300000-0000-0000-0000-000000000003', 'wg500000-0000-0000-0000-000000000005']::UUID[], NOW() - INTERVAL '7 days'),
    ('k8000000-0000-0000-0000-000000000008', 'Test-AK', 'Testberg-37', '1936-12-18', 'männlich', '5', 'Testnotiz Pflegebedarf E', 'Kontakt Testberg-37', 'Ehefrau', '+49 30 00000005', 'anonym37@example.de', 'entscheidung_ausstehend', 'empfehlung', 'sofort', NULL, ARRAY['wg400000-0000-0000-0000-000000000004']::UUID[], NOW() - INTERVAL '10 days');
