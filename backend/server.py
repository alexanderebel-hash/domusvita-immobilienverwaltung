...
async def seed_klienten_data():
    ...
    interessenten = [
        {"id": generate_id(), "vorname": "Erika", "nachname": "Testfrau", "geschlecht": "weiblich", "pflegegrad": "3", "besonderheiten": "Fortgeschrittene Demenz, benötigt 24h Betreuung", "kontakt_name": "Thomas Testfrau", "kontakt_beziehung": "Sohn", "kontakt_telefon": "+49 30 55500001", "kontakt_email": "test1@example.com", "status": "neu", "anfrage_quelle": "email", "dringlichkeit": "sofort", "bevorzugte_wgs": ["wg-drachenwiese", "wg-drachenblick"]},
        {"id": generate_id(), "vorname": "Hans-Dieter", "nachname": "Mustermann", "geschlecht": "männlich", "pflegegrad": "2", "besonderheiten": "Leichte kognitive Einschränkungen", "kontakt_name": "Petra Mustermann", "kontakt_beziehung": "Tochter", "kontakt_telefon": "+49 30 55500002", "kontakt_email": "test2@example.com", "status": "erstgespraech", "anfrage_quelle": "telefon", "dringlichkeit": "4_wochen", "bevorzugte_wgs": ["wg-sterndamm"]},
        {"id": generate_id(), "vorname": "Hildegard", "nachname": "Beispielfrau", "geschlecht": "weiblich", "pflegegrad": "4", "besonderheiten": "Bettlägerig, PEG-Sonde", "kontakt_name": "Sandra Beispielfrau", "kontakt_beziehung": "Tochter", "kontakt_telefon": "+49 30 55500003", "kontakt_email": "test3@example.com", "status": "besichtigung_geplant", "anfrage_quelle": "vermittlung", "vermittler": "Beispiel-Klinik Berlin", "dringlichkeit": "sofort", "bevorzugte_wgs": ["wg-drachenwiese"]},
        {"id": generate_id(), "vorname": "Lieselotte", "nachname": "Demofrau", "geschlecht": "weiblich", "pflegegrad": "3", "besonderheiten": "Diabetes, Herzinsuffizienz", "kontakt_name": "Martin Demofrau", "kontakt_beziehung": "Sohn", "kontakt_telefon": "+49 30 55500004", "kontakt_email": "test4@example.com", "status": "unterlagen_gesendet", "anfrage_quelle": "website", "dringlichkeit": "3_monate", "bevorzugte_wgs": ["wg-kupferkessel-klein", "wg-drachenblick"]},
        {"id": generate_id(), "vorname": "Otto", "nachname": "Platzhalter", "geschlecht": "männlich", "pflegegrad": "5", "besonderheiten": "Schwere Demenz, Weglauftendenz", "kontakt_name": "Helene Platzhalter", "kontakt_beziehung": "Ehefrau", "kontakt_telefon": "+49 30 55500005", "kontakt_email": "test5@example.com", "status": "entscheidung_ausstehend", "anfrage_quelle": "empfehlung", "dringlichkeit": "sofort", "bevorzugte_wgs": ["wg-drachenwiese"]},
    ]
...
# H-03: Rate Limiting — 60 req/min per IP (default)
def _get_real_ip(request):
    """Get real client IP behind Azure Container Apps reverse proxy."""
